            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route('createTaskForm')}}">Add new task</a></li>
            ...
            <div class="top-right">
                <div class="header-menu">
                    <div class="header-left"> --}}
                        ...
                        {{-- <a href="{{route('Logout')}}" class="search-trigger">LogOut</a>
